...
def truncate_table(table: str = "") -> bool:
    ...
    if v_table == "all":
        v_return = truncate_ge('ge_termmap')
        v_return = truncate_ge('ge_wordmap')
        v_return = truncate_ge('ge_wordterm')
        v_return = truncate_ge('ge_term')
        v_return = truncate_ge('ge_termcategory')
        v_return = truncate_ge('ge_termgroup')
        v_return = truncate_ge('ge_logs')
        v_return = truncate_ge('ge_wfcontrol')
        v_return = truncate_ge('ge_dstcolumn')
        v_return = truncate_ge('ge_prefixopc')
        v_return = truncate_ge('ge_connector')
        v_return = truncate_ge('ge_datasource')
