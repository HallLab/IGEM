...
def test_ge_db_delete_data_connector():
    x = db.delete_data(
        table='connector',
        connector={'connector__in': ['alfa_con']})
    assert x is True
...
def test_ge_db_delete_data_wordterm_by_term():
    x = db.delete_data(
        table='wordterm',
        term={'term_id__term__in': ['alfa_term']})
    assert x is True
...
def test_ge_db_delete_data_term_category():
    x = db.delete_data(
        table='term_category',
        term_category={'term_category__in': ['alfa_cat']})
    assert x is True
...
def test_ge_db_delete_data_term_group():
    x = db.delete_data(
        table='term_group',
        term_group={'term_group__in': ['alpa_group']})
    assert x is True
...
def test_ge_db_load_data_datasource():
    x = db.load_data(
        table='datasource',
        path='/users/andrerico/dev/datasource.csv'
        )
    assert x is True
...
def test_ge_db_load_data_connector():
    x = db.load_data(
        table='connector',
        path='/users/andrerico/dev/connector.csv'
        )
    assert x is True
...
def test_ge_db_load_data_ds_column():
    x = db.load_data(
        table='ds_column',
        path='/users/andrerico/dev/ds_column.csv'
        )
    assert x is True
...
def test_ge_db_load_data_term_category():
    x = db.load_data(
        table='term_category',
        path='/users/andrerico/dev/term_category.csv'
        )
    assert x is True
...
def test_ge_db_load_data_term_group():
    x = db.load_data(
        table='term_group',
        path='/users/andrerico/dev/term_group.csv'
        )
    assert x is True
...
def test_ge_db_load_data_term():
    x = db.load_data(
        table='term',
        path='/users/andrerico/dev/term.csv'
        )
    assert x is True
...
def test_ge_db_load_data_prefix():
    x = db.load_data(
        table='prefix',
        path='/users/andrerico/dev/prefix.csv'
        )
    assert x is True
...
def test_ge_db_load_data_wordterm():
    x = db.load_data(
        table='wordterm',
        path='/users/andrerico/dev/wordterm.csv'
        )
    assert x is True
...
def test_ge_db_load_data_termmap():
    x = db.load_data(
        table='termmap',
        path='/users/andrerico/dev/termmap.csv'
        )
    assert x is True
